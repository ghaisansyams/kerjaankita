...
import { TaskDrawer, type TaskDetailVM } from "./task-drawer";

/**
 * Server component that loads everything the task drawer needs and renders it.
 * Shared by the Tasks tab and the Board so both open the same drawer in place.
 * Returns null when the id doesn't resolve to a task in this project (RLS-safe).
 */
